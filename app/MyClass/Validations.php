...
class Validations
{
    ...
    public static function prizePoolValidation($request)
    {
        $request->validate([
            'name' => 'required',
            'picture' => 'mimes:jpeg,png,jpg,svg|max:2048',
        ],
        [
            'name.required' => 'judul tidak boleh kosong',
            'picture.max' =>'Gambar tidak boleh lebih dari 2048 px',
            'picture.mimes' => 'format gambar harus berupa jpeg, png, jpg, dan svg',
        ]);
    }

    public static function prizePoolEditValidation($request)
    {
        $request->validate([
            'name' => 'required',
            'picture' => 'mimes:jpeg,png,jpg,svg|max:2048',
