...
<head>
    ...
    <link href="{{ url('css/sb-admin-2.min.css') }}" rel="stylesheet">
     <style>
        .bg-gradient-primary {
            background: linear-gradient(to bottom, #007bff, #f6c23e) !important;
        }

        .bg-primary {
            background: linear-gradient(to right, #007bff, #f6c23e) !important;
        }
...
<!-- Sidebar - Brand -->
            <div class="sidebar-brand d-flex align-items-center justify-content-center">
                <div class="sidebar-brand-icon">
                    <img src="{{ url('assets/img/img/icon.png') }}" alt="Logo" width="200" height="120">
                </div>
            </div>
            <div class="sidebar-brand-text mt-2">Ace Jaya Renewable Energy</div>
            ...
            <!-- Nav Item  -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('tecnician.solar_task.index') }}">
            ...
            <!-- Nav Item  -->
            {{-- <li class="nav-item">
                <a class="nav-link" href="{{ route('teknisi.info_uninstall') }}">
                    <i class="fas fa-fw fa-ban"></i>
                    <span>Order Putus Daya</span></a>
            </li> --}}
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a href="#" class="dropdown-item"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Ubah Profil</a>
