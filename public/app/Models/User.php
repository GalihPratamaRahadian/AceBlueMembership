...
class User extends Authenticatable
{
    ...
    public function roleHtml()
    {
        ...
        }elseif ($this->role == self::ROLE_CUSTOMER) {
            return'<span class="badge text-bg-primary">Pelanggan</span>';
        }elseif ($this->role == self::ROLE_TECHNICIAN) {
            return'<span class="badge text-bg-danger">Teknisi</span>';
        }
